...
export type CountryPrefix = {
  ...
  export const countryPrefixes: CountryPrefix[] = [
    ...
    { name: "Antarctica", code: "AQ", prefix: "+672", flag: "🇦🇶" },
    ...
    { name: "Christmas Island", code: "CX", prefix: "+61", flag: "🇨🇽" },
    { name: "Cocos Islands", code: "CC", prefix: "+61", flag: "🇨🇨" },
    ...
    { name: "Curacao", code: "CW", prefix: "+599", flag: "🇨🇼" },
    ...
    { name: "East Timor", code: "TL", prefix: "+670", flag: "🇹🇱" },
    ...
    { name: "Guernsey", code: "GG", prefix: "+44", flag: "🇬🇬" },
    ...
    { name: "Isle of Man", code: "IM", prefix: "+44", flag: "🇮🇲" },
    { name: "Israel", code: "IL", prefix: "+972", flag: "🇮🇱" },
    { name: "Italy", code: "IT", prefix: "+39", flag: "🇮🇹" },
    { name: "Ivory Coast", code: "CI", prefix: "+225", flag: "🇨🇮" },
    ...
    { name: "Netherlands Antilles", code: "AN", prefix: "+599", flag: "🇳🇱" },
    ...
    { name: "Puerto Rico", code: "PR", prefix: "+1787", flag: "🇵🇷" },
    { name: "Qatar", code: "QA", prefix: "+974", flag: "🇶🇦" },
    { name: "Republic of the Congo", code: "CG", prefix: "+242", flag: "🇨🇬" },
    { name: "Reunion", code: "RE", prefix: "+262", flag: "🇷🇪" },
    { name: "Romania", code: "RO", prefix: "+40", flag: "🇷🇴" },
    { name: "Russia", code: "RU", prefix: "+7", flag: "🇷🇺" },
    { name: "Rwanda", code: "RW", prefix: "+250", flag: "🇷🇼" },
    { name: "Saint Barthelemy", code: "BL", prefix: "+590", flag: "🇧🇱" },
    ...
    { name: "U.S. Virgin Islands", code: "VI", prefix: "+1340", flag: "🇻🇮" },
